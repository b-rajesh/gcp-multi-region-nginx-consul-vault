resource "google_compute_instance_template" "f1-microservice-template" {
  name       = "${var.random_id}--${var.region_name}-f1-ms-template"
...
resource "google_compute_region_instance_group_manager" "f1-microservice-group-manager" {
  name               = "${var.random_id}-regional-f1-ms-instance-group-manager"
